...
<li class="dropdown" onclick="toggleDisplay('4')">
    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                <legend>Delete Attendance</legend>
                <?php
                    include('init.php');
                    include('session.php');
...
<?php
    if(isset($_POST['class_name'],$_POST['rno'])) {
        ...
        echo $class_name;
        echo $rno;
        $delete_sql=mysqli_query($conn,"DELETE from `attendance` where `rno`='$rno' and `class`='$class_name'");
        if(!$delete_sql){
    ...
    if(isset($_POST['rn'],$_POST['w'],$_POST['p'],$_POST['class'])) {
        $rno=$_POST['rn'];
        ...
        $sql="UPDATE `attendance` SET `w`='$w',`p`='$p',`total`='$total',`attpercentage`='$attpercentage' WHERE `rno`='$rno' and `class`='$class_name'";
